...
Every selected light and dark text token meets WCAG AA against its canvas. The lowest light text contrast is `light-meta` at 5.43:1; the lowest dark text contrast is `dark-meta` at 5.88:1. The dark accent is 9.53:1 against the canvas, 8.54:1 against the ordinary dark surface, and 6.83:1 against the stronger dark surface. The thin border tokens are deliberately low-contrast decorative separators and must not become the sole boundary or focus indication for an interactive control.
